    ...
    describe "validation" $ do
        ...
        describe "objects" $ do
          ...
          it "should handle multiple fields" $ do
            ...
            (A.Object [("required", A.String "some text")
                      ,("optional", A.Number 42)
                      ]
             `isValidFor`
             Object [("required", Field Plain $ String "text")
                    ,("optional", Field Optional $ Number 44)
                    ])
              `shouldBe` True
          ...
          it "should handle nested objects" $ do
            (A.Object [("outer", A.Object [("inner", A.String "data")])]
             `isValidFor`
             Object [("outer", Field Plain $ Object [("inner", Field Plain $ String "something")])])
              `shouldBe` True


            (A.Object [("type", A.String "person")
                      ,("data", A.Object [("age", A.Number 50)
                                         ,("name", A.String "Albert")
                                         ])
                      ]
             `isValidFor`
             Object [("type", Field Exact $ String "person")
            ...
            (A.Object [("type", A.String "person")
                      ,("data", A.Object [("name", A.String "Albert")])
                      ]
             `isValidFor`
             Object [("type", Field Exact $ String "person")
                    ,("data", Field Plain $ Object [("age", Field Plain $ Number 50)
        ...
        describe "arrays" $ do
          ...
          it "should flatten arrays when asked" $ do
            (A.Object [("flat", A.String "value")] `isValidFor` Object [("flat", Field Flat $ Array [String "value"])]) `shouldBe` True
            (A.Object [("flat", A.String "value")] `isValidFor` Object [("flat", Field Flat $ Array [Number 3, String "value"])]) `shouldBe` True
            (A.Object [("flat", A.Array [A.String "value"])] `isValidFor` Object [("flat", Field Flat $ Array [String "value"])]) `shouldBe` False
        ...
        describe "tagged unions" $ do
          it "Should be able to encode tagged unions" $ do
            ...
            (A.Array [A.Object [("type", A.String "person")]]
             `isValidFor`
             Array [Object [("type", Field Exact $ String "person")]])
              `shouldBe` True


            (A.Array [A.Object [("type", A.String "persor")]]
             `isValidFor`
             Array [Object [("type", Field Exact $ String "person")]])
              `shouldBe` False
            ...
            (A.Array [A.Object [("type", A.String "persons")
                               ,("data", A.Object [("age", A.Number 50)
                                                  ,("name", A.String "Albert")
                                                  ])
                               ]
